module.exports = {
    ...
    resolve: {
        alias: {
            ...
            'solid-auth-client$': `${__dirname}/dist/esm/polyfills/fetch.js`,
            'solid-auth-cli$': `${__dirname}/dist/esm/polyfills/fetch.js`,
            'node-fetch$': `${__dirname}/dist/esm/polyfills/fetch.js`,
        }
    }
}